...
<div class="card-group w-full p-5">
    <div class="card">
        ...
        <div class="number relative z-50 ">066801031297501 <span class="btn cursor-pointer"
                data-clipboard-text="066801031297501"><i class="fa fa-copy" id="icon-coppy"></i></span>

        </div>
        <div class="name">Ego Oktafanda</div>
        <div class="ring"></div>
    </div>
</div>
<script>
